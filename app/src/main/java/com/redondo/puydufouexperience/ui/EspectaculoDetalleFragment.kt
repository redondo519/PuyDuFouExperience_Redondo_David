...
class EspectaculoDetalleFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_espectaculo_detalle, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment EspectaculoDetalleFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EspectaculoDetalleFragment().apply {
